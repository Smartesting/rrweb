...
describe('utils', () => {
  ...
  describe('inputNeedsMasking', () => {
    ...
    it('returns the value set for the tag in maskInputOptions', () => {
      expect(
        inputNeedsMasking(textarea, { textarea: true }, null, 'textarea', null),
      ).toEqual(true);
      expect(
        inputNeedsMasking(
          textarea,
    ...
    it('returns false if the tagname is not specified in maskInputOptions', () => {
      expect(inputNeedsMasking(textarea, {}, null, 'textarea', null)).toEqual(
        false,
      );
    });
    ...
    it('uses the type of the input if available', () => {
      expect(
        inputNeedsMasking(input, { text: true }, null, 'input', 'text'),
      ).toEqual(true);
      expect(
        inputNeedsMasking(input, { text: false }, null, 'input', 'text'),
      ).toEqual(false);
    });

    it('returns false if the type is not specified in maskInputOptions', () => {
      expect(inputNeedsMasking(input, {}, null, 'input', 'text')).toEqual(
        false,
      );
    });
